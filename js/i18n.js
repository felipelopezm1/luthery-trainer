...
const I18N = {
  es: {
    ...
    metro_voice: 'Sonido', metro_voice_aria: 'Sonido del metrónomo',
    metro_voice_tick: 'Clic', metro_voice_wood: 'Caja china', metro_voice_drum: 'Tambor',
    metro_voice_agogo: 'Agogó', metro_voice_piano: 'Piano', metro_voice_cello: 'Cello',
    metro_voice_violin: 'Violín', metro_voice_guitar: 'Guitarra',
    ...
    cello_piece: 'Squire · Danse Rustique · Op. 20 No. 5',
    cello_piece_sub: 'Partitura centrada · vídeo de referencia a la derecha · el micrófono sincroniza ambos.',
    cello_upload: 'Tu partitura',
    cello_piece_pick: 'Pieza',
    cello_string: 'Cuerda',
    cello_play: 'Seguir', cello_pause: 'Pausa', cello_stop: 'Parar', cello_listen: 'Micrófono',
    cello_paused: 'Pausa · espacio para seguir',
    cello_ready: 'Cargando Danse Rustique…',
    cello_sync: 'Toca el comienzo para sincronizar la partitura y el vídeo',
    cello_sync_ok: 'Sincronizado',
    cello_ens_hint: 'Ensemble de fondo',
    cello_example_ready: 'Ejemplo listo · {m}/{bt} · {bpm} BPM',
    cello_example_err: 'No se pudo cargar el ejemplo. Sube un PDF, MusicXML o MIDI.',
    cello_pdf_ready: 'Partitura PDF · {n} páginas · {m}/{bt} · {bpm} BPM',
    cello_pdf_loaded: 'PDF · {n} páginas',
    cello_pdf_prev: 'Página anterior', cello_pdf_next: 'Página siguiente',
    cello_loaded: '{n} notas · {m}/{bt} · {bpm} BPM', cello_load_err: 'No se pudo leer el archivo.',
    cello_following: 'Compás {bar} · {m}/{bt} · ♩={bpm}',
    ...
    cello_pane: 'Cello',
    instr_cello: 'Cello',
    instr_viola: 'Viola', instr_violin: 'Violín', instr_bass: 'Contrabajo',
    instr_pizz: 'Pizzicato', instr_ensemble: 'Ensemble',
    cello_yt_label: 'Vídeos de referencia',
    cello_yt_ph: 'Busca o pega un enlace de YouTube',
    cello_yt_go: 'Ir',
    cello_yt_add: 'Añadir',
    cello_yt_paste: 'Pega un enlace de YouTube',
    cello_yt_searching: 'Buscando…',
    cello_yt_fail: 'Pega el enlace aquí, o',
    cello_yt_open: 'abrir en YouTube',
    cello_yt_empty: 'Busca o pega un enlace. El vídeo se queda aquí.',
    cello_yt_saved: 'Guardados',
    cello_yt_none: 'Aún no hay vídeos guardados.',
    cello_yt_change: 'Cambiar vídeo',
  },
  en: {
    brand: 'BELE TRAINER',
    ...
    metro_voice: 'Sound', metro_voice_aria: 'Metronome sound',
    metro_voice_tick: 'Click', metro_voice_wood: 'Woodblock', metro_voice_drum: 'Drum',
    metro_voice_agogo: 'Agogo', metro_voice_piano: 'Piano', metro_voice_cello: 'Cello',
    metro_voice_violin: 'Violin', metro_voice_guitar: 'Guitar',
    theme_dark: 'DARK', theme_light: 'LIGHT',
    ...
    cello_piece: 'Squire · Danse Rustique · Op. 20 No. 5',
    cello_piece_sub: 'Centered score · reference video on the right · the mic locks both together.',
    cello_upload: 'Your score',
    cello_piece_pick: 'Piece',
    cello_string: 'String',
    cello_play: 'Follow', cello_pause: 'Pause', cello_stop: 'Stop', cello_listen: 'Mic',
    cello_paused: 'Paused · space to continue',
    cello_ready: 'Loading Danse Rustique…',
    cello_sync: 'Play the opening to sync the score and the video',
    cello_sync_ok: 'Synced',
    cello_ens_hint: 'Background ensemble',
    cello_example_ready: 'Example ready · {m}/{bt} · {bpm} BPM',
    cello_example_err: 'Could not load the example. Upload a PDF, MusicXML, or MIDI.',
    cello_pdf_ready: 'PDF score · {n} pages · {m}/{bt} · {bpm} BPM',
    cello_pdf_loaded: 'PDF · {n} pages',
    cello_pdf_prev: 'Previous page', cello_pdf_next: 'Next page',
    cello_loaded: '{n} notes · {m}/{bt} · {bpm} BPM', cello_load_err: 'Could not read that file.',
    cello_following: 'Bar {bar} · {m}/{bt} · ♩={bpm}',
    ...
    cello_pane: 'Cello',
    instr_cello: 'Cello',
    instr_viola: 'Viola', instr_violin: 'Violin', instr_bass: 'Double bass',
    instr_pizz: 'Pizzicato', instr_ensemble: 'Ensemble',
    cello_yt_label: 'Reference videos',
    cello_yt_ph: 'Search or paste a YouTube link',
    cello_yt_go: 'Go',
    cello_yt_add: 'Add',
    cello_yt_paste: 'Paste a YouTube link',
    cello_yt_searching: 'Searching…',
    cello_yt_fail: 'Paste the link here, or',
    cello_yt_open: 'open on YouTube',
    cello_yt_empty: 'Search or paste a link. The video stays here.',
    cello_yt_saved: 'Saved',
    cello_yt_none: 'No videos saved yet.',
    cello_yt_change: 'Change video',
  },
};
...
function instrLabel(id) {
  const map = { piano: 'instr_piano', wind: 'instr_wind', brass: 'instr_brass', strings: 'instr_strings', guitar: 'instr_guitar', organ: 'instr_organ', cello: 'instr_cello', viola: 'instr_viola', violin: 'instr_violin', bass: 'instr_bass', pizz: 'instr_pizz', ensemble: 'instr_ensemble' };
